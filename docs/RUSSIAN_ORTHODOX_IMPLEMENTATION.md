...
> **Оновлення 2026-09-05:** штатна православна панель, одна з чотирьох ікон,
> ціна 10 пунктів авторитету та коефіцієнт власних бонусів 0,95 описані у
> [документі вікна](RUSSIAN_ORTHODOX_BLESSING_WINDOW.uk.md).
> Старі описи аспектів та іконостаса нижче не є чинною специфікацією цих механік.
