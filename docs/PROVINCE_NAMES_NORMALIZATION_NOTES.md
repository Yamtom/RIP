...
> **Замінено.** Поточний стан `common/province_names/` описує
> [PROVINCE_NAMES.md](PROVINCE_NAMES.md). Нижче — архів попереднього
> нормалізаційного проходу; як опис репозиторію він не чинний.
