...
Культурна колоніальна назва `RIP_COLONIAL_CANADA_RUTHENIAN` має форму
**Nova Volyn** як власну руську назву. Це точковий виняток для назви держави;
правило **Volhynia** в англійській оповідній прозі зберігається.
